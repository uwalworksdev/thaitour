...
class JkBbs extends JkClass
{
	...
	public $data_path = ROOTPATH."public/data/bbs/";
	public $editor_path = ROOTPATH."public/uploads/editor/";
	...
	function check_perm($r_idx, $r_act)
	{
		...
		// 관리자
		// if ($this->is_admin == "Y" || session('member.level') = "1")
			return array("status" => "Y");
		...
		// 기본 정책에 따라 허용/불허
		return array("msg" => "권한이 없습니다.-" . session('member.level'));
	}
