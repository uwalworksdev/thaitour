...
class OrdersModel extends Model
{
    ...
    protected $allowedFields = [
		...
		, "id_kakao_en", "time_line_en", "tours_idx", "tour_type_en", "number_staff", "number_luggage", "cus_cnt", "metting_date", "special_request", "notes_invoice", "chk_notes_invoice" , "product_golf"
    ];
