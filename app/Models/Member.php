...
class Member extends Model
{
    ...
    protected $allowedFields = [
        "user_id", "user_pw", "user_name", "user_first_name_en", "user_last_name_en", "gender", "part", "position", "user_email",
        ...
        foreach ($members as &$row) {
            if ($row['encode'] == 'Y') {
                $sql_d = "SELECT
                            ...
                            AES_DECRYPT(UNHEX(?), ?) AS user_first_name_en,
                            AES_DECRYPT(UNHEX(?), ?) AS user_last_name_en";
                ...
                $result_d = $this->db->query($sql_d, [
                    ...
                    $row['user_first_name_en'], $private_key,
                    $row['user_last_name_en'], $private_key]);
                ...
                $row['user_first_name_en'] = $row_d['user_first_name_en'];
                $row['user_last_name_en'] = $row_d['user_last_name_en'];
