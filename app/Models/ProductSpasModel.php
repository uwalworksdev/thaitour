...
class ProductSpasModel extends Model
{
    ...
    protected $allowedFields = ['product_idx', 'spas_subject', 'spas_subject_eng', 'spas_price', 'spas_price_kids', 'spas_price_baby', 'spas_price_ori', 'spas_price_kids_ori', 'spas_price_baby_ori', 'spas_price_max', 'spas_price_kids_max', 'spas_price_baby_max', 'r_date', 'status', 'info_idx'];
