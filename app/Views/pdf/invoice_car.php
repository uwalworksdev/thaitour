            ...
            <div class="invoice_table">
                ...
                <table class="invoice_tbl">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?= $row->order_no ?></td>
                            <th>예약날짜</th>
                            <td><?= esc(substr($row->order_date, 0, 10)) ?>(<?= get_korean_day(substr($row->order_date, 0, 10)); ?>)
                            </td>
                        </tr>
                        <tr>
                            <th>예약자</th>
                ...
                <table class="invoice_tbl">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>출발지/도착지</th>
                            <td><?= !empty($row->departure_name_) ? $row->departure_name_ : $departure_name ?></span> /
                                <span><?= !empty($row->destination_name_) ? $row->destination_name_ : $destination_name ?>
                            </td>
                            <th>총인원</th>
                ...
                <div class="invoice_golf_total flex_e_c">
                    <p>총 견적서 금액 : <span><?= number_format($row->real_price_won) ?>원</span>
                        (<?= number_format($row->real_price_bath) ?>바트)</p>
                </div>
