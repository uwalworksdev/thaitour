            ...
            <div class="inner">
                ...
                <div class="invoice_table">
                    ...
                    <div class="invoice_note_">
                        <div  style="display: flex; align-items: center; margin-bottom: 13px;"><img style="opacity: 0.7; width : 20px;" src="/images/sub/warning-icon.png" alt=""><span style="margin-left: 20px;  font-size: 20px; font-weight: 600;">참고사항</span></div>
