            ...
            <div class="inner">
                ...
                <div class="invoice_table">
                    ...
                    <div class="invoice_note_" style="position: relative">
                        <p  style="display: flex; align-items: center; margin-bottom: 13px;"><img style="opacity: 0.7; width : 20px; position: absolute; top: 0; left: 0;" src="/images/sub/warning-icon.png" alt=""><span style="padding-left: 30px;  font-size: 20px; font-weight: 600;">참고사항</span></p>
