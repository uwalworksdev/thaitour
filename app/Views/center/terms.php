	...
	<div class="inner">
		<div class="contentArea">
			<div class="content_wrap">
				...
				<p>
					<strong>
						<font color="#000000">[ 하이호주는 소비자 보호에 관한 법률과 기타 관련법령의 규정 및 국내 외 여행 표정 약관등에 의해 약관을 운영합니다 ]</font>
						<br><br>
					</strong><br>
				</p>
				<p>
				...
				<p>이 약관은 ㈜에스에스케이투어가 운영하는 하이호주 웹사이트(이하 "사이트"라 한다)<br>에서 제공하는 인터넷관련 서비스 (이하 "서비스"라 한다)를 이용함에 있어 <br>이용자의
