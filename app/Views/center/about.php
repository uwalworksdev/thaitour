...
<section id="sub_container" class="intro">
    ...
    <div class="intro_content">
        <div class="inner_1000">
            ...
            <div class="box_content">
                <div class="info_box">
                    <div class="item">
                        <img src="/img/center/it_ic_1.png" alt="" class="icon_left">
                        <div class="text">
                            <p class="title">MBTI 성향분석 </p>
                            <p class="desc"> 여행객의 성향을 파악하고 죄적화 추천을 위한 MBTI 검색 기능 적용 </p>
                        </div>
                    </div>
                    <div class="item">
                        <img src="/img/center/it_ic_2.png" alt="" class="icon_left">
                        <div class="text">
                            <p class="title">최적화 큐레이션 </p>
                            <p class="desc"> 분석된 여행객의 성향을 기반으로 최적화된 호텔과 투어 서비스 추천 </p>
                        </div>
                    </div>
                    <div class="item">
                        <img src="/img/center/it_ic_3.png" alt="" class="icon_left">
                        <div class="text">
                            <p class="title">다양한 프로모션 </p>
                            <p class="desc"> 태국 내 모든 호텔, 투어, 골프 등의 다양한 프로모션과 최저가 예약 제공</p>
                        </div>
                    </div>
                </div>
                <div class="list_img">
    ...
    <div class="intro_location">
        <div class="inner_1000">
            <div class="heading">
                <div class="logo">
                    <img src="/img/center/logo_the.png" alt="">
                    <div class="span">Company Information</div>
                </div>
                <div class="cont">
                    <div class="item">
                        <span class="time">2015.09 </span>
                        <p class="desc">‘타이투어 어드벤처’<br>
                            태국 전문 온라인<br>
                            여행사 오픈
                        </p>
                        <p class="bot"> IN BOUND Only</p>
                    </div>
                    <div class="item">
                        <img src="/img/center/ab-img8.png" alt="">
                    </div>
                    <div class="item">
                        <span class="time"> 2025.03</span>
                        <p class="desc">더투어랩’<br>
                            동남아 전문 온라인<br>
                            여행사로 확장‘
                        </p>
            ...
            <p class="intro_tit">더투어랩 연혁</p>
            <p class="intro_ttl">다시 떠나고 싶은 여행을 <br> 만드는 더투어랩. </p>
                    ...
                    <div class="wrap_">
                        <div class="view flex">
                            ...
                            <div class="view_cont">
                                <div class="num">
                                    <p>05</p>
                                    <span>‘더투어랩’ 동남아 전문 온라인 여행사로 확장</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="view flex">
                            ...
                            <div class="view_cont">
                                <div class="num">
                                    <p>09</p>
                                    <span>‘타이투어어드벤처’ 태국 전문온라인 여행사 오픈 </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="view flex">
                            ...
                            <div class="view_cont">
                                <div class="num">
                                    <p>03</p>
                                    <span>‘파타야 산호섬 어드벤처 투어’ 오프라인 투어사오픈 </span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="inner_1000">
            ...
            <table class="table_info">
                ...
                <tbody>
                    <tr>
                        <th>법인명</th>
                        <td><?= $setting['home_name'] ?></td>
                        <th>브랜드</th>
                        <td><?= $setting['brand_name'] ?></td>
                    </tr>
                    <tr>
                        <th>사업자등록번호</th>
                        <td><?= $setting['comnum'] ?></td>
                        <th>대표자</th>
