                                ...
                                <td class="custom-td-product-info">
                                    <div class="product-info">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <div class="product-desc">디럭스 연박 프로모션 더블(2룸) / 조식포함</div>
                                            <div class="product-people">성인 4 / 아동 2</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="custom-td-product-info">
                                    <div class="product-info">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <div class="product-date">2024.08.10(토)</div>
                                            <div class="product-desc">54홀 골프 패키지1(54홀 라운딩 + 갤러리12 2인 1실 + 전일차량</div>
                                            <div class="product-people">성인 4 / 아동 2</div>
                                        </div>
                                    </div>
                                </td>
