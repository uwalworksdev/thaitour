        ...
        <div class="main-container">
            <div class="side-bar">
                ...
                <div class="list-item-bar">
                    ...
                    <div class="itembar active"><a href="/community/customer_center/notify_table">1 : 1 게시판</a></div>
            ...
            <div class="form-customer">
                <div class="menu">
                    ...
                    <form action="#">
                        ...
                        <input type="제목" id="제목" name="제목" placeholder="">

                        <label for="lname">첨부파일</label>
                        <div class="upload-container">
                            <label for="file-upload" class="upload-label">첨부파일</label>
                            <div class="upload-info">
                                <input type="file" id="file-upload" multiple class="upload-input">
                                <span class="upload-text">최대 3개까지 30MB, JPG, PNG 파일만 첨부 가능합니다.</span>
                            </div>
                            <button class="upload-button" id="upload-button">파일첨부</button>
                        </div>

                        <div class="uploaded-file-list" id="uploaded-file-list"></div>
                        <label for="w3review">내용*</label>

                        <textarea id="내용" name="내용" rows="4" cols="50">
                        </textarea>

                        <label for="w3review">이메일 주소*</label>
                        <input type="text" placeholder="이메일">@
                        <select name="cars" id="cars">
                            <option value="선택해주세요.">선택해주세요.</option>
                        </select>
                        <label for="답변여부를 메일로 받으시겠습니까?">답변여부를 메일로 받으시겠습니까?</label>
                        <input type="radio" id="예" name="예" value="예">
                        <label for="예">예</label><br>
                        <input type="radio" id="아니오" name="아니오" value="아니오">
                        <label for="아니오">아니오</label>
                    </form>
                    <div class="btn-con">
