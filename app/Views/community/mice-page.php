...
.section_2 .bot_content {
  ...
  max-width: 1600px;
  height: 510px;
  background: url("/img/sub/group_section_2_bot_content_bg_w.png")
    no-repeat center;
}
  ...
  <section class="section_2">
    <div class="inner">
      <div class="top_content">
        ...
        <p class="description">더투어랩은 시드니 현지에서 20년 이상을 오직 더투어랩만을 연구, 개발, 기획한 노하우로 직접 계약부터 투어까지<br class="only_web">원스톱
          시스템으로 진행하여 고민, 시간,
