                        ...
                        <div class="card-left2">
                            ...
                            <div class="con-form mb-40">
								...
								<div class="form-group">
									...
									<input type="text" id="order_passport_expiry_date" class="date_form hasDatepicker" name="order_passport_expiry_date" required="" data-label="여권만기일" placeholder="여권만기일" readonly="true">
								</div>
					        </div>		
                            ...
                            <div class="con-form mb-40">
								<div class="form-group">
									...
									<input type="text" id="order_birth_date" class="date_form hasDatepicker" name="order_birth_date" required="" data-label="생년월일" placeholder="생년월일" readonly="true">
								</div>
					        </div>							
