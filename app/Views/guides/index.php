                    ...
                    <div class="swiper-wrapper cursor-pointer-con">
                        ...
                        <?php foreach ($products as $product) { ?>
                            <div class="swiper-slide"
                                 onclick="location.href='/guide-detail/<?= $product['product_idx'] ?>'">
                ...
                <div class="">
                    <div class="list-ticket-grid " id="list-ticket-grid">
                        ...
                        <?php foreach ($productResults as $product) { ?>
                            <a href="/guide-detail/<?=$product['product_idx'] ?>" class="list-ticket-item">
                                <div class="img_box">
                                ...
                                <div class="prd_price_ko prd_price_ko_m">
                                    <span class="prd_price"><?= number_format($product['product_price_won']) ?></span>
                                    <span
