    ...
    <section class="golf_invoice hotel_invoice">
        <div class="inner">
            ...
            <div class="invoice_table">
                ...
                <div class="table_wrapper invoice_table" style="margin-top: 20px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="background-color: #f2f2f2;" colspan="2">
                                    ...
                                    <p>- 견적서는 예약 또는 실제 이용 당사자에게 결제 점구용으로 발행된 문서로 해당 견적서를 다른 목적으로 사용할 경우(호텔 또는 제3자에게 최저가 보장을 요구하기 위한 목적 등) 민/형사상의 불이익을 당할 수 있습니다.</p>
...
<script>
    ...
    $(document).on('click', '#btn_pdf', function () {
        ...
        location.href='/pdf/invoice_ticket?order_idx='+order_idx;
    });
</script>