    ...
    <div class="inner">
        <div>
            <ul class="flex_footer_top pl-10">
                <li><a href="/center/about">회사소개</a></li>
                ...
                <li><a href="/contact/write">제휴문의</a></li>
        ...
        <div class="flex_footer_bot">
            <div class="footer_l">
                ...
                <div class="add_footer">
                    ...
                    <p>관광사업자 등록번호 : <?= $setting['tournum_thai']?></p>
                </div>
                ...
                <div>
                    <ul class="footer_icon">
                        ...
                        <li><a href="https://www.facebook.com/THETOURLAB/" target="_blank"><img class="only_web" src="/images/ico/bl_fb.png" alt=""><img
                                        class="only_mo" src="/images/ico/bl_fb_m.png" alt=""></a></li>
