    ...
    <tr class="product_area">
        <td colspan="2">
            <table cellpadding="0" cellspacing="0" summary="" class="listTable mem_detail"
                ...
                <tbody>
                    <tr>
                        <input type="hidden" name="product_idx[<?=$product['index']?>][]" value="<?=$product['product_idx']?>">
                            ...
                            <table cellpadding="0" cellspacing="0" summary="" class="listTable mem_detail product_area"
                                ...
                                <tbody>                                                                
                                    <tr>
                                        <th>상품명</th>
                                        <td colspan="3">
                                            <input type="text" name="theme_name[<?=$product['index']?>][]"
                                    ...
                                    <tr>
                                        <th>등급</th>
                                        <td colspan="3">
                                            <select name="star[<?=$product['index']?>][]" class="input_select">
                                    ...
                                    <tr>
                                        <th>내용</th>
                                        <td colspan="3">
                                            <textarea name="recommend_text[<?=$product['index']?>][]" rows="10" cols="100"  class="input_txt"  style="width:100%; height:100px;"><?= viewSQ($product['product_info']) ?></textarea><textarea name="product_info" id="product_info" rows="10" cols="100"  class="input_txt"  style="width:100%; height:400px; display:none;"><?= viewSQ($product_info) ?></textarea>
                                        </td>
                                    </tr>
                                                ...
                                                ?>
                                                    <div class="file_input_wrap">
                                                        <div class="file_input <?= empty($product['ufile' . $i]) ? "" : "applied" ?>">
                                                            <input type="file" name='ufile_<?= $i ?>[<?=$product['index']?>][]' id="ufile<?= $i ?>"
