                                    ...
                                    <tr style="height:30px" data-idx="<?= $row['idx']; ?>">
                                        ...
                                        <td>
                                            <div class="flex_button">
                                                <button onclick="window.location.href='write?city_code=<?= $city_code ?>&category_code=<?= $category_code ?>&search_category=<?= $search_category ?>&search_txt=<?= $search_txt ?>&pg=<?= $pg ?>&idx=<?= $row["idx"] ?>'"
