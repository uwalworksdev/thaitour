                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="url" class="bbs_inputbox_pixel" style="width:400px"
                                               value="" placeholder="URL을 입력하셔야 합니다."/><br>
                            ...
                            foreach ($result as $row) {
                                ...
                                <form name="frm_<?= $i ?>" action="file_update.php" method=post
                                    ...
                                    <tr style="height:45px;padding:5px">
                                        <td><?= $i ?></td>
                                        <td>
                                            <a href="/data/banner/<?= $row["ufile1"] ?>" class="imgpop"><img
                                                        src="/data/banner/<?= $row["ufile1"] ?>"
                                                        style="max-height:200px"><br><br>

                                        </td>
                                        <td>
                                            <a href="/data/banner/<?= $row["ufile2"] ?>" class="imgpop"><img
                                                        src="/data/banner/<?= $row["ufile2"] ?>"
