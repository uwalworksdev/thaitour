        ...
        <div id="print_this"><!-- 인쇄영역 시작 //-->
            ...
            <div id="contents">
                ...
                <div class="listWrap">
                            ...
                            <table cellpadding="0" cellspacing="0" summary="" class="listTable">
                               ...
                               foreach ($result as $row) {
                                    ...
                                    <tr style="height:50px">
                                        ...
                                        <td class="tac">
                                            <?php if ($row["img"]) { ?>
                                                <img src="/data/banner/<?= $row["img"] ?>"
                                                     style="width: 255px; height:100px;">
                                            <?php } ?>
                                        </td>
                                        <td class="tal"><a
                                                    href="write?code_idx=<?= $row["code_idx"] ?>&s_parent_code_no=<?= $s_parent_code_no ?>"><?= $row["code_name"] ?></a>
                                        </td>
                    ...
                    <?php echo ipageListing($pg, $nPage, $g_list_rows, site_url('/AdmMaster/_codeBanner/list') . "?ca_idx=$ca_idx&search_category=$search_category&search_name=$search_name&pg=") ?>
