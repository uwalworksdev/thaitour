            ...
            <div class="listWrap_noline">
                <form name="frm" id="frm" action="./list" method="get">
                    ...
                    <div class="listBottom">
                        ...
                        <div class="menu_tab">
                            <a href="/AdmMaster/_tourSuggestion/list_spa" class="btn btn_fil active">상품관리</a>
                            <a href="/AdmMaster/_cateBanner/write?code_no=1325&code_idx=1262&s_parent_code_no=" class="btn btn_fil">배너관리</a>
                        </div>
