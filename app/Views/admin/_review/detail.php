...
<div id="container"> <span id="print_this"><!-- 인쇄영역 시작 //-->
	...
	<header id="headerContainer">
		<div class="inner">
			...
			<div class="menus"> 
				<ul >
					<li><a href="/AdmMaster/_review/write.php?idx=<?= $idx ?>" class="btn btn-default"><span class="glyphicon glyphicon-cog"></span><span class="txt">수정</span></a></li>
                    <li><a href="javascript:del_it('<?= $idx ?>');" class="btn btn-default"><span class="glyphicon glyphicon-trash"></span><span class="txt">삭제</span></a></li>
			...
			<!-- // listBottom --> 
				<div class="tail_menu">  
					<ul>
						<li class="left"></li>  
						<li class="right_sub">  
							<a href="/AdmMaster/_review/write.php?idx=<?= $idx ?>" class="btn btn-default"><span class="glyphicon glyphicon-cog"></span><span class="txt">수정</span></a>
                    		<a href="javascript:del_it('<?= $idx ?>');" class="btn btn-default"><span class="glyphicon glyphicon-trash"></span><span class="txt">삭제</span></a>
