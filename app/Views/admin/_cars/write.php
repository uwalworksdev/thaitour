                ...
                <form name="sFrm" id="sFrm" method="post" enctype="multipart/form-data">
                    ...
                    <table class="listTable mem_detail">
                        ...
                        <tbody id="list_option_sub">
                            ...
                            ?>
                                <tr>
                                    <input type='hidden' name='cars_sub_idx[]' class='cars_sub_idx' value='<?=$car_sub["idx"]?>'>
                                    <td>
                                        <div class="flex_c_c">
                                            <input type='hidden' name='departure_code[]' class='departure_code' value='<?=$car_sub["departure_code"]?>'>
                                            <span class='departure_name'><?=$car_sub["departure_name"]?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex_c_c">
                                            <input type='hidden' name='destination_code[]' class='destination_code' value='<?=$car_sub["destination_code"]?>'>
                                            <span class='destination_name'><?=$car_sub["destination_name"]?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <input type='text' name='car_price[]' class='car_price' maxlength="10" value='<?=$car_sub["car_price"]?>'>
                                    </td>
                                    <td class='tac'>
                                        <button style='margin: 0;' type='button' class='btn_02' onclick='delOptionSub("<?=$car_sub["idx"]?>", this);'>삭제</button>
                                    </td>
                                </tr>
                            <?php
                                }
