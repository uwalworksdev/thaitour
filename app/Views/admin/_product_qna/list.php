		...
		<div id="contents">
			<form name="search" id="search">
				...
				<header id="headerContents">
					...
					<input type="text" id="" name="search_txt" value="<?= $search_txt ?>" class="input_txt placeHolder"
