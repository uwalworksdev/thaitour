                    ...
                    */ 
                    ...
                    <table class="listIn">
                        ...
                        <tbody class="statistics">
                            <tr>
                                <td>
                                    <div class="nums"><?=number_format(array_sum($pc_point_arr) + array_sum($mobile_point_arr));?>(원)</div>
                                    <div>
                                ...
                                <td>
                                    <div class="nums"><?=number_format(array_sum($pc_coupon_arr) + array_sum($mobile_coupon_arr));?>(원)</div>
                                    <div>
                                        <span><i class="xi-desktop masterTooltip" title="PC"></i> <?=number_format(array_sum($pc_coupon_arr))?></span><span><i class="xi-tablet masterTooltip" title="모바일"></i> <?=number_format(array_sum($mobile_coupon_arr))?></span>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="listIn fixed-header">
                        ...
                        <tbody class="count_per" id="count_all">
                            <?php for ($i = 1; $i <= 7; $i++) { ?>
                                <tr>
                                    <td class="number"><?= $yoil_arr[$i] ?></td>
                                    <td class="number"><?= number_format($point_arr[$i]  * 100 / array_sum($point_arr)) ?> <span><?= $point_arr[$i] ?>%</span></td>
                                    <td class="number"><?= number_format($coupon_arr[$i] * 100 / array_sum($coupon_arr)) ?> <span><?= $coupon_arr[$i] ?>%</span></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
