                    ...
                    <script type="text/javascript">
                        ...
                        function drawChart1() {
                            ...
                            var data = google.visualization.arrayToDataTable([
                                ...
                                ['월', <?= $price_arr[1] ?>, '매출 : <?= number_format($price_arr[1]) ?>원 <br/> <!--CP수수료 : <?= number_format($cp_arr[1]) ?>원 <br/--> 상품 : <?= number_format($cnt_arr[1]) ?>개'],
                                ['화', <?= $price_arr[2] ?>, '매출 : <?= number_format($price_arr[2]) ?>원 <br/> <!--CP수수료 : <?= number_format($cp_arr[2]) ?>원 <br/--> 상품 : <?= number_format($cnt_arr[2]) ?>개'],
