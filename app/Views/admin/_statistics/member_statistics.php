        ...
        <div id="contents">
            ...
            <div class="content">
                ...
                <div class="listSelect size09">
                    <form name="modifyForm1" method="get" action="member_statistics" autocomplete="off">
                        ...
                        <div class="firstLine selectYear" style="padding-left:0">
                            ...
                            <select name="days" onchange="fn_search()">
                                <?php for ($dt = 1; $dt <= date('t', mktime(0, 0, 0, $months, 1, $years)); $dt++) { ?>
                                    <option value="<?= $dt ?>" <?php if ($dt == $days) echo "selected"; ?>><?= $dt ?>일</option>
                                <?php } ?>
                            </select>
                        </div>
                    </form>
