        ...
        <div id="contents">
            ...
            <div class="content">
                ...
                <div class="listSelect size09" style="position:relative">
                    <form name="modifyForm1" method="get" action="member_statistics4_week" autocomplete="off">
                ...
                <div class="listSelectR">
                    <div class="contentMenu">
                        <ul>
                            ...
                            <li class="contentMenuSub selected" data-mode="week" style="width: calc(20% - 2px);"><a href="member_statistics4_week">주간통계</a></li>
