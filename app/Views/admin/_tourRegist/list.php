						...
						<tbody>
							...
							<tr style="height:50px" data-idx="<?=$row['product_idx'];?>">
								...
								<td rowspan="2" class="tac">
									...
									<br>
									<a href="<? echo '/t-package/item_view.php?product_idx=' . $row['product_idx']?>" class="product_view" target="_blank">[<span>상품상세</span>]</a>
								</td>
								<td rowspan="2" class="tac"><?=$row["product_code"]?></td>
								<td class="tac">
									<? if ($row["ufile1"] != "") { ?>
									<a href="/data/product/<?=$row["ufile1"]?>" class="imgpop"><img src="/data/product/<?=$row["ufile1"]?>" style="max-width:150px;max-height:100px" onerror="this.src='/data/product/noimg.png'"></a>
									<? } else {?>
									<a href="/data/product/noimg.png" class="imgpop"><img src="/data/product/noimg.png" style="max-width:150px;max-height:100px" onerror="this.src='/data/product/noimg.png'"></a>
									<?}?>
								</td>
								<td class="tal" style="font-weight:bold">
									<a href="write.php?s_product_code_1=<?=$s_product_code_1?>&s_product_code_2=<?=$s_product_code_2?>&s_product_code_2=<?=$s_product_code_3?>&search_category=<?=$search_category?>&search_name=<?=$search_name?>&pg=<?=$pg?>&product_idx=<?=$row["product_idx"]?>">
							...
							<tr style="height:45px">
								...
								<td colspan="9" style="background:#fafafa;;text-align:left;padding-left:15px;font-weight:bold">
