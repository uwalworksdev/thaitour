...
<?= $this->section("body") ?>
                ...
                <div class="inner">
                    ...
                    <div class="menus">
                        ...
                        <ul class="last">
                            ...
                            <li><a href="write_honeymoon" class="btn btn-primary"><span
                                ...
                                foreach ($result as $row) :
                                    ...
                                    <tr style="height:50px" data-idx="<?= $row['product_idx']; ?>">
                                        ...
                                        <td class="tal" style="font-weight:bold">
                                            <a href="write_honeymoon?s_product_code_1=<?= $s_product_code_1 ?>&s_product_code_2=<?= $s_product_code_2 ?>&s_product_code_2=<?= $s_product_code_3 ?>&search_category=<?= $search_category ?>&search_name=<?= $search_name ?>&pg=<?= $pg ?>&product_idx=<?= $row["product_idx"] ?>">
                                                <?= viewSQ($row["product_name"]) ?>
                                            </a><br>최저가 : <?= number_format($row['product_price']) ?>원
    ...
    <script>
        function go_write(idx) {
            $("#product_idx").val(idx);
            $("#search").attr("action", "/write_honeymoon").submit();
        }
    </script>
