    ...
    <div id="print_this"><!-- 인쇄영역 시작 //-->
        <header id="headerContainer">
            <div class="inner">
                ...
                <div class="menus">
                    <ul>
     					<li><a href="/product-golf/golf-detail/<?= $product_idx?>" class="btn btn-default"><span class="glyphicon glyphicon-th-list"></span><span class="txt">상품미리보기</span></a></li>
                        <li>
					...
					<table cellpadding="0" cellspacing="0" summary="" class="listTable mem_detail"
                        ...
                        <tr height="45">
                            ...
                            <td colspan="3">
                                ...
                                -->
                                <input type='hidden' name='a_sdate' /> 
                                <input type='hidden' name='a_edate' />
                        ...
                        <td>
                            ...
                            <tr height="45">
                                ...
                                <td>
									...
									<button type="button" id="btn_update_option" class="btn_01" 
									    onclick="updDay('<?= $row['product_idx'] ?>','<?= $row['group_idx'] ?>','<?= $row['sdate'] ?>','<?= $row['edate'] ?>')">일자별수정</button>
								    ...
								    <?php $i = $i+1; ?>	
                                        <table>
                                            ...
                                            <tr id="option_<?= $frow3['idx'] ?>">
												...
												<?php
																  $frow3['goods_price1_1'] =  0;
																  $frow3['goods_price1_2'] =  0;
																  $frow3['goods_price1_3'] =  0;
															   
																  $frow3['goods_price2_1'] =  0;
																  $frow3['goods_price2_2'] =  0;
																  $frow3['goods_price2_3'] =  0;
															   
																  $frow3['goods_price3_1'] =  0;
																  $frow3['goods_price3_2'] =  0;
																  $frow3['goods_price3_3'] =  0;
															   
																  $frow3['goods_price4_1'] =  0;
																  $frow3['goods_price4_2'] =  0;
																  $frow3['goods_price4_3'] =  0;
															   
																  $frow3['goods_price5_1'] =  0;
																  $frow3['goods_price5_2'] =  0;
																  $frow3['goods_price5_3'] =  0;
															   
																  $frow3['goods_price6_1'] =  0;
																  $frow3['goods_price6_2'] =  0;
																  $frow3['goods_price6_3'] =  0;
															   
																  $frow3['goods_price7_1'] =  0;
																  $frow3['goods_price7_2'] =  0;
                                            ...
                                            <tr color='<?= $_tmp_color ?>' size='<?= $frow2['type'] ?>'>
                                                <td colspan="6"><span class="badge">왕복</span>&nbsp;
                                                    ...
                                                    SUV:        <input type='text' name='optGolf[<?=$i?>][vehicle_o_price3]' style="width:7%;text-align:right;" value='<?= $frow3['vehicle_o_price3'] ?>'/>&nbsp;&nbsp;
                                                    밴 (승합차): <input type='text' name='optGolf[<?=$i?>][vehicle_o_price2]' style="width:7%;text-align:right;" value='<?= $frow3['vehicle_o_price2'] ?>'/>(단위: 바트)  
                                                </td>    
                                        ...
                                        <?php foreach ($options1 as $frow3): ?>
                                            <?php if ($frow3['option_type'] == "S") { ?>
                                                <tr color='<?= $_tmp_color ?>' size='<?= $frow2['type'] ?>' data-room-id="<?= $frow3['idx'] ?>">
                                                    ...
                                                    <td>
                                                        <select name="o_sale[]" >
                                                             <option value="Y" <?php if($frow3['o_sale'] == "Y") echo "selected";?> >판매중</option>
                                                             <option value="N" <?php if($frow3['o_sale'] != "Y") echo "selected";?> >중지</option>
                                                        </select>
                                                    </td>
													<td>
        ...
        <div class="tail_menu">
            <ul>
                <li class="left"></li>
                <li class="right_sub">
			        <a href="/product-golf/golf-detail/<?= $product_idx?>" class="btn btn-default"><span class="glyphicon glyphicon-th-list"></span><span class="txt">상품미리보기</span></a>
                    <a href="list_golf?s_product_code_1=<?= $s_product_code_1 ?>&s_product_code_2=<?= $s_product_code_2 ?>&s_product_code_2=<?= $s_product_code_3 ?>&search_name=<?= $search_name ?>&search_category=<?= $search_category ?>&pg=<?= $pg ?>"
                        class="btn btn-default">
                        <span class="glyphicon glyphicon-th-list"></span>
                        <span class="txt">리스트</span>
