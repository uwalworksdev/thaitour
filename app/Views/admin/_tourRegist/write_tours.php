                            ...
                            <table cellpadding="0" cellspacing="0" summary="" class="listTable mem_detail">
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										&ensp;이메일: <input id="phone1" name="phone" class="input_txt" type="text" value="<?= $phone ?? '' ?>"   style="width:150px"/>
                                        &ensp;연락처: <input id="email1" name="email" class="input_txt"  type="text" value="<?= $email ?? '' ?>"   style="width:150px"/>
                                    </td>
                                    <!-- <th>이용항공</th>
                                    <td>
