                                        ...
                                        <div>
                                            <table>
                                                ...
                                                <?php foreach ($row_option['additional_options'] as $option): ?>
                                                    <tr>
                                                        <td>
                                                            <input type='text' name='o_name[]'     id='o_name_<?= $option['idx'] ?>'     value="<?= $option['option_name'] ?>"     size="50"/>
                                                            <input type='text' name='o_name_eng[]' id='o_name_eng_<?= $option['idx'] ?>' value="<?= $option['option_name_eng'] ?>" size="50"/>
                                                        </td>
                                                        <td>
