            ...
            <div class="inner">
                ...
                <div class="menus">
                    ...
                    <ul class="last">
                        ...
                        <li><a href="/AdmMaster/_tourRegist/golf_vehicles/write?s_parent_code_no=<?= $s_parent_code_no ?>" class="btn btn-primary"><span
                            ...
                            <tbody>
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr style="height:50px">
                                        ...
                                        <td>
                                            <a href="/AdmMaster/_tourRegist/golf_vehicles/write/<?= $row["code_idx"] ?>?s_parent_code_no=<?= $s_parent_code_no ?>"><img src="/images/admin/common/ico_setting2.png"></a>
                                            <?php if ($row["cnt"] == 0) { ?>
