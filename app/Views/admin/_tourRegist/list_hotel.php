        ...
        <div id="contents">
            <form name="search" id="search">
                ...
                <table cellpadding="0" cellspacing="0" summary="" class="listTable01" style="table-layout:fixed;">
                    ...
                    <tbody>
                    <tr>
                        <td class="label">카테고리<?=$product_code_1?></td>
                        <td>
                            ...
                            foreach ($result as $row) :
                                ...
                                <tr style="height:50px" data-idx="<?= $row['product_idx']; ?>">
                                    ...
                                    <td class="tal" style="font-weight:bold">
                                        <a href="write?s_product_code_1=<?= $s_product_code_1 ?>&s_product_code_2=<?= $s_product_code_2 ?>&s_product_code_2=<?= $s_product_code_3 ?>&search_category=<?= $search_category ?>&search_name=<?= $search_name ?>&pg=<?= $pg ?>&product_idx=<?= $row["product_idx"] ?>">
