										...
										<?php foreach ($roresult as $item): ?>
												<tr style="height:40px">
													...
													<td style="text-align:center">
														...
														<input type="text" name="price_1[]" id="price_1_<?=$item['idx']?>" value="<?=number_format($item['price_1'])?>" class="price goods_price input_txt" numberonly="true" style="text-align:right;width:10%;">
														<input type="text" name="price_2[]" id="price_2_<?=$item['idx']?>" value="<?=number_format($item['price_2'])?>" class="price goods_price input_txt" numberonly="true" style="text-align:right;width:10%;">
														<input type="text" name="price_3[]" id="price_3_<?=$item['idx']?>" value="<?=number_format($item['price_3'])?>" class="price goods_price input_txt" numberonly="true" style="text-align:right;width:10%;">
													</td>
													<!--td style="text-align:center">
