...
#("#selectedHoles").val(selectedHoles); // 출력 예: "18홀,36홀"
                ...
                <?= ipageListing($pg, $nPage, $g_list_rows, site_url('/AdmMaster/_tourRegist/list_golf_price?product_idx='.$product_idx.'&group_idx='.$group_idx.'&goods_name='.$goods_name.'&s_date='.$s_date.'&e_date='.$e_date) . $search_val . "&pg=") ?>
...
<!-- // container -->
        ...
        <form name="priceForm" id="priceForm" method="get" action="/AdmMaster/_tourRegist/list_golf_price">
            ...
            <input type="text" name="holes"   id="selectedHoles"   value="<?=$selectedHoles?>">
