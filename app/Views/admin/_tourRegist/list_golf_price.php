			...
			<div id="contents">
                <div class="listWrap_noline">
					...
					<!--button type="button" class="allUpdate" >일괄수정</button-->
                        ...
                        <a href="#!" id="changeE" class="btn btn-primary"  style="margin-left:10px">일괄 마감/해제</a>  
                    ...
                    $(document).ready(function () {
                        $('#dowCharge').click(function () {
							    ...
							    if($("#dowPrice_1").val() < "1" && $("#dowPrice_2").val() < "1" && $("#dowPrice_2").val() < "1") {
								     alert('적용할 금액을 입력하세요.');
									 $("#dowPrice_1").focus();
									 return false;
                                }
                ...
                <?= ipageListing($pg, $nPage, $g_list_rows, 
				    site_url('/AdmMaster/_tourRegist/list_golf_price?product_idx='.$product_idx.'&group_idx='.$group_idx.'&holes='.$holes.'&s_date='.$s_date.'&e_date='.$e_date.'&g_list_rows='.$g_list_rows) . $search_val . "&pg=") ?>
