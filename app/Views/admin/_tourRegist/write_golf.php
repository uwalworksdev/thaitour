											...
											<table>
												...
												<tbody id="tblgolf<?= $grow['o_golf'] ?>">
													<tr id="option_<?= $frow3['idx'] ?>">
														...
														<td>
															<input type="text" numberonly="true" name="goods_price1[]" style="text-align:right;width:" id="goods_price1_<?= $frow3['idx'] ?>" value='<?= $frow3['goods_price1'] ?>'>
                                                        </td>
                                                        <td>
															<input type="text" numberonly="true" name="goods_price2[]" style="text-align:right;width:" id="goods_price2_<?= $frow3['idx'] ?>" value='<?= $frow3['goods_price2'] ?>'>
                                                        </td>
                                                        <td>
															<input type="text" numberonly="true" name="goods_price3[]" style="text-align:right;width:" id="goods_price3_<?= $frow3['idx'] ?>" value='<?= $frow3['goods_price3'] ?>'>
                                                        </td>
                                                        <td>
															<input type="text" numberonly="true" name="goods_price4[]" style="text-align:right;width:" id="goods_price4_<?= $frow3['idx'] ?>" value='<?= $frow3['goods_price4'] ?>'>
                                                        </td>
                                                        <td>
															<input type="text" numberonly="true" name="goods_price5[]" style="text-align:right;width:" id="goods_price5_<?= $frow3['idx'] ?>" value='<?= $frow3['goods_price5'] ?>'>
                                                        </td>
                                                        <td>
															<input type="text" numberonly="true" name="goods_price6[]" style="text-align:right;width:" id="goods_price6_<?= $frow3['idx'] ?>" value='<?= $frow3['goods_price6'] ?>'>
                                                        </td>
                                                        <td>
															<input type="text" numberonly="true" name="goods_price7[]" style="text-align:right;width:" id="goods_price7_<?= $frow3['idx'] ?>" value='<?= $frow3['goods_price7'] ?>'>
														</td>
														<td rowspan="2">
													...
													<tr color='<?= $_tmp_color ?>' size='<?= $frow2['type'] ?>'>
														<td colspan="3">
															적용기간: <input type='text' readonly class='datepicker ' name='o_sdate[]' style="width:50%" value='<?= $frow3['o_sdate'] ?>' /> ~
															         <input  type='text' readonly class='datepicker ' name='o_edate[]' style="width:50%" value='<?= $frow3['o_edate'] ?>' />
		...
		$(document).ready(function(){
			...
			$("#btn_add_option").click(function(){
				...
				if(exists == false)
				{
							...
							addOption += "	</td>																  ";
							addOption += "	<td>																  ";
							addOption += "		<input type='text' class='onlynum' name='o_price4[]'  value='' /> ";
							addOption += "	</td>																  ";
							addOption += "	<td>																  ";
							addOption += "		<input type='text' class='onlynum' name='o_price5[]'  value='' /> ";
							addOption += "	</td>																  ";
							addOption += "	<td>																  ";
							addOption += "		<input type='text' class='onlynum' name='o_price6[]'  value='' /> ";
							addOption += "	</td>																  ";
							addOption += "	<td>																  ";
							addOption += "		<input type='text' class='onlynum' name='o_price7[]'  value='' /> ";
							addOption += "	</td>																  ";
							...
							addOption += "	</tr>																  ";
							addOption += "	<tr>																  ";
							addOption += "	<td colspan='7'>																  ";
							addOption += "		적용기간: <input type='text' class='datepicker' readonly name='o_sdate[]'  value='' style='width:10%' /> ~ ";
							addOption += "		         <input type='text' class='datepicker' readonly name='o_edate[]'  value='' style='width:10%' /> ";
