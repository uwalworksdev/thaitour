                                            ...
                                            <table>
                                                ...
                                                <tr color='<?= $_tmp_color ?>' size='<?= $frow2['type'] ?>'>
                                                    ...
                                                    <td colspan="4">
                                                        ...
                                                        <input type='text' name="o_day_price[]" value="<?= $frow3['o_day_price'] ? $frow3['o_day_price'] : 0 ?>" numberonly="true" style='width:30%;text-align:right;'>
                                                        ...
                                                        <input type='text' name="o_night_price[]" value="<?= $frow3['o_night_price'] ? $frow3['o_night_price'] : 0 ?>" numberonly="true" style='width:30%;text-align:right;'>
