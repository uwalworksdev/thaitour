                                ...
                                <td>
                                    <div class="container_date flex__c" style="margin: 0">
										...
										<div style="text-align:left;">
											<input type="text" name="s_date" id="s_date" value="<?=data('Y-m-d')?>" style="text-align: center;background: white; width: 120px;" readonly> ~
											<input type="text" name="e_date" id="e_date" value="<?=data('Y-m-d')?>" style="text-align: center;background: white; width: 120px;" readonly>
										</div>
