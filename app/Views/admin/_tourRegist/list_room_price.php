    ...
    <div id="print_this"><!-- 인쇄영역 시작 //-->
        ...
        <header id="headerContainer">
            <div class="inner">
                ...
                <div class="menus">
                    <ul>
                        <li><a href="/AdmMaster/_tourRegist/write_price?product_idx=<?=$product_idx?>" class="btn btn-default"><span
                    ...
                    <div class="tail_menu">
                        <ul>
                            ...
                            <li class="right_sub">
                                ...
                                <a href="/AdmMaster/_tourRegist/write_price?product_idx=<?=$product_idx?>" class="btn btn-default"><span
                                            class="glyphicon glyphicon-th-list"></span><span class="txt">상품보기</span></a>
                                <?php if ($product_idx == "") { ?>
