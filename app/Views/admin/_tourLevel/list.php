        ...
        <div id="print_this"><!-- 인쇄영역 시작 //-->
            ...
            <div id="contents">
                ...
                <div class="listWrap">
                            ...
                            <table cellpadding="0" cellspacing="0" summary="" class="listTable">
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr style="height:50px">
                                        <td><?= $num-- ?></td>
                                        <td class="tac"><a
                                                    href="write?idx=<?= $row["idx"] ?>"><?= $row["level_name"] ?></a>
                                        </td>
                                        <td class="tac"><a href="write?idx=<?= $row["idx"] ?>"><?= $status ?></a>
                                        </td>
                                        <td><?= $row["r_date"] ?></td>
                                    </tr>
                                <?php } ?>
                    ...
                    <?= ipageListing($pg, $nPage, $g_list_rows, site_url('/AdmMaster/_tourLevel/list') . "?s_country_code_1=" . $s_country_code_1 . "&s_country_code_2=" . $s_country_code_2 . "&s_country_code_2=" . $s_country_code_3 . "&search_category=" . $search_category . "&search_name=" . $search_name . "&pg=") ?>
