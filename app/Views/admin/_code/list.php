						...
						<tbody>
							...
							<tr style="height:50px">
								...
								<td class="tac">
									...
									<input type="hidden" name="code_idx[]" value="<?=$row["code_idx"]?>" class="input_txt"/>
								</td>
								<td>
								    <?php if($row["cnt"] == 0) { ?>
									<a href="#!" onclick="code_delete('<?=$row["code_idx"]?>');" class="btn btn-default">코드삭제</a>
									<?php } ?>
									<a href="write?s_parent_code_no=<?=$row["code_no"]?>" class="btn btn-default">추가등록</a>
									&nbsp;&nbsp;
									<a href="list?s_parent_code_no=<?=$row["code_no"]?>" class="btn btn-default">하위리스트</a>
								</td>
							</tr>
							<?php  } ?>
