            ...
            <div id="contents">
                <div class="listWrap_noline">
                    <div class="listBottom">
                        <div style="font-size:12pt;margin-bottom:10px">■ 예약정보(<?=$code_name?>)</div>
                        <table cellpadding="0" cellspacing="0" summary="" class="listTable mem_detail">
                            ...
                            <tr>
                                    ...
                                    <th>예약일시</th>
                                    <td>
                                        <input type="text" id="order_day" name="order_day"
                                               value="<?= $order_day ?>" class="input_txt" style="width:40%"/>
                                        <input type="text" id="time_line" name="time_line"
                                               value="<?= $time_line ?>" class="input_txt" style="width:40%"/>
                                    </td>
                                </tr>
                            <tr>
                                <th>휴대전화</th>
                            ...
                            <tr>
                                ...
                                <th>등록일</th>
                                <td>
                                    <input type="text" id="order_r_date" name="order_r_date"  value="<?= $order_r_date ?>" class="input_txt" style="width:90%"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th>예약상품</th>
                                <td colspan="3">
                                    <input type="hidden" name="op_idx[]" value="<?= $row['opt_idx'] ?>"/>
								    <input type="text" name="op_name[]" value="<?=$row['option_name']?>" class="input_txt" style="width:200px;"/> 
                                    <input type="text" name="op_price[]" value="<?=number_format($row['option_price'])?>" class="input_txt number-only price" style="width:100px;"/> 
                                    X <input type="text" name="op_cnt[]" value="<?=$row['option_qty']?>" class="input_txt number-only" style="width:50px;" maxlength="3"/>명
								</td>
                            </tr>
							<?php endforeach; ?>
                            ...
                            <tr style="height:100px">
                                <th>요청사항</th>
                                <td colspan="3">
                                        <textarea id="custom_req" name="custom_req" class="input_txt" style="width:90%;height:80px"><?php echo $custom_req ?: $order_memo ?></textarea>
                                </td>
                            </tr>
                            <tr style="height:100px">
                                <th>관리자 메모</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <select name="order_status" class="select_txt">
										...
										<button class="btn btn-primary" type="button" style="width: unset;" onclick="window.open('/invoice/ticket_01/<?=$order_idx?>', 'window_name', 'width=900, height=700, location=no, status=no, scrollbars=yes');">인보이스 보기</button>&emsp;
                                    ...
                                    <td>
										...
										<button class="btn btn-primary" type="button" style="width: unset;" onclick="window.open('/voucher/ticket/<?=$order_idx?>?type=admin', 'window_name', 'width=900, height=700, location=no, status=no, scrollbars=yes');">바우처 보기</button>&emsp;
										...
										<!-- <input type="text" id="order_user_email" name="order_user_email"
											   ...
											   <input type="text" id="order_user_email" name="order_user_email"
                                               value="<?= $order_user_email ?>" class="input_txt" style="width:35%" placeholder="고객 이메일"/>
											   <button type="button" class="btn btn btn-danger" style="width: unset;" onclick="" placeholder="스파 이메일">스파 메일발송</button><BR>
                                    </td>
                                </tr>
