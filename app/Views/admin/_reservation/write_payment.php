                            ...
                            <table cellpadding="0" cellspacing="0" summary="" class="listTable mem_detail">
                                ...
                                <tr>
								    ...
								    <tr>
                                        <th>주문 문자발송(알림톡)</th>
                                        <td colspan="3">
                                         <button type="button" class="btn btn-primary" style="width: unset;" onclick="allimtalk1('<?= $payment_row['payment_idx'] ?>','UA_5373');">예약접수</button>
										 ...
										 <button type="button" class="btn btn-primary" style="width: unset;" onclick="allimtalk1('<?= $payment_row['payment_idx'] ?>','UA_5328');">결제완료</button>
										 <button type="button" class="btn btn-primary" style="width: unset;" onclick="allimtalk1('<?= $payment_row['payment_idx'] ?>','UA_5348');">예약취소</button>
                                        </td>
                                    </tr>
