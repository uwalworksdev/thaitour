            ...
            <form name=frm action="/AdmMaster/_settlement/write_ok/<?= $order_idx ?>" method=post enctype="multipart/form-data" target="hiddenFrame">
                ...
                <div id="contents">
                    <div class="listWrap_noline">
                        ...
                        <!-- 지출정보 S: -->
                        <!-- 상품구분 / 날짜 / 금액 / 결제방법 / 업체명 / 명세서 / 비고-->
                        <?php
                        $sql_sum = " SELECT IFNULL(SUM(exp_amt), 0) AS total_expense FROM tbl_expense_hist WHERE order_idx = '$order_idx'";
                        $result_sum = mysqli_query($connect, $sql_sum) or die(mysqli_error($connect));
