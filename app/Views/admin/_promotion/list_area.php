    ...
    <div id="print_this"><!-- 인쇄영역 시작 //-->
        ...
        <div id="contents">
            ...
            <div class="listWrap">
                ...
                <?= ipageListing($pg, $nPage, $g_list_rows, site_url('/AdmMaster/_promotion/list_area') . "?search_category=$search_category&g_list_rows=$g_list_rows&search_name=$search_name&pg=") ?>
...
<script>
    function change_it() {
        ...
        let url = '<?= route_to("admin._promotion.change") ?>'
...
<script>
    function submitForm() {
        ...
        var pg = '<?= $pg ?>';
        location.href = '/AdmMaster/_promotion/list?search_category=' + search_category + '&product_name=' + product_name + '&g_list_rows=' + g_list_rows + '&search_name=' + search_name + '&pg=' + pg;
    }
</script>
...
<script>
    ...
    function SELECT_DELETE() {
        ...
        let url = "<?= route_to("admin._promotion.del") ?>";
        $.ajax({
            url: url,
            type: "POST",
            data: $("#frm").serialize(),
