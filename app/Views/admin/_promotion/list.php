    ...
    <div id="print_this"><!-- 인쇄영역 시작 //-->
        ...
        <div id="contents">
            ...
            <div class="listWrap">
                                    ...
                                    <tr style="height:30px">
                                        ...
                                        <td>
                                            <div class="flex_button">
                                                <button onclick="prod_update('<?= $row['idx'] ?>');"
                ...
                <?= ipageListing($pg, $nPage, $g_list_rows, site_url('/AdmMaster/_promotion/list') . "?search_category=$search_category&g_list_rows=$g_list_rows&search_name=$search_name&pg=") ?>
