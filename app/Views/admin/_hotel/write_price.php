													...
													<tr>
														...
														<td style="background-color: #eee;">
															...
															<div class="btns_setting">
																...
																<button type="button" style="width: 50px ; background-color: #d03a3e; color : #fff;" class="btn_del room_delete" data-idx="<?=$type['g_idx']?>" value="<?=$row['rooms_idx']?>">룸 삭제</button>
															</div>
														</td>
													</tr>
													...
													<tr class="bed_child_<?=$roomIdx?>" data-bed-idx="<?=$bed['bed_idx']?>" data-bed-seq="<?=$bed['bed_seq']?>" >
														<td>
															...
															<input style="width:18%;" type="text" name="bed_type[<?=$roomIdx?>][]"  value="<?=$bed['bed_type']?>" >
                 											<?php  
																 $result  = todayPriceView($db, $product_idx, $type['g_idx'], $rooms_idx, $bed['bed_idx']);
															     $arr     = explode("|", $result);
