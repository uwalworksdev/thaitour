    ...
    <section class="login_cont">
      ...
      <div class="login_box on">
        ...
        <div class="input-group">
          <div class="input-row">
            <input type="text" name="user_id" class="bs-input" onkeyup="press_it()" placeholder="아이디를 입력하세요." value="<?=$_COOKIE['c_userId']?>" >
          </div>
          <div class="input-row">
            <input type="password" name="user_pw" class="bs-input" onkeyup="press_it(event)" placeholder="비밀번호를 입력하세요."  >
          </div>
          <div class="input-row save_id flex_b_c">
            <div class="bs-input-check">
				<input type="checkbox" id="save_id" name="save_id" value="Y" <?php if ($_COOKIE['c_userId'] != "") {echo "checked";} ?>>
        ...
        <div class="btn-wrap"><button type="button" class="btn btn-lg btn-point" onclick="login_it();">로그인</button></div>
		</form>
        ...
        <div class="another_login">
          ...
          <button type="button" id="customBtn" class="another_btn google" onclick="location.href='<?=$_url?>'">
            구글로그인
          </button>
        </div>
      ...
      <div class="login_box">
		...
		<form action="/mypage/trabel_goods_non.php" id="resulrForm" name="frm2" method="post" class="login_form02">
          <div class="input-row">
        ...
        <div class="btn-wrap"><button type="button" class="btn btn-lg btn-point tab_2" onclick="go_result();">예약확인</button></div>
        </form>
