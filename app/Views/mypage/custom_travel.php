            ...
            <div class="mypage_wrap">
                ...
                <form id="frm" name="frm" class="content">
                    ...
                    <table class="details_table mo">
                        ...
                        foreach ($result as $row) {
                            ...
                            <tr>
                                ...
                                <td class="des"><a
                                            href="../mypage/custom_travel_view?idx=<?= $row["idx"] ?>"><?= sqlSecretConver($row["user_email"], 'decode') ?></a>
                                </td>
                                <td class="stt">
                    ...
                    <div class="cancel flex_b_c">
                        ...
                        <a href="/custom_travel/item_write" class="btn btn-lg btn-point contact_btn"
