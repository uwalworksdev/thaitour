                    ...
                    <div class="product_box">
                        <div class="book_group_wrap flex_b_c">
                            <div class="name_pro">
                                <div class="bs-input-check">
                                    <input type="checkbox" id="grp<?= esc($group['group_no']) ?>" data-grp="<?= esc($group['group_no']) ?>" name="product01" value="Y">
                        ...
                        <div class="product_detail">
                            <div class="info_product">
                                <div class="bs-input-check">
                                    <?php if($order['order_status'] == "X") echo '<input type="checkbox" id="product01_01" name="product01_01" value="Y">';?>
