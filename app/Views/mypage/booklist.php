                    ...
                    <div class="product_box">
                        ...
                        <div class="product_detail">
                            <div class="info_product">
                                <div class="bs-input-check">
                                    <?php if($order['order_status'] == "X") echo '<input type="checkbox" data-price="'. $order['order_price'] .'" id="product01_01" name="product01_01" class="pay sub'.esc($group['group_no']).'" value="Y">';?>
