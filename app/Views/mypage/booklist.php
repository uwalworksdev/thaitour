...
<div class="group_movement_popup_wrap" style="display:none;">
    <!-- 여기 안에 Ajax로 가져온 내용이 들어가야 함 -->
</div>
...
function openGroupMovement() {
    ...
    // 닫기 버튼 바인딩 (중복 방지 위해 off)
    $(".group_movement_popup_wrap .btn_close_popup").off("click").on("click", function () {
        $(".group_movement_popup_wrap").hide();
    });
}
</script>
