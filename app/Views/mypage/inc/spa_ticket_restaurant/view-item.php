    ...
    <div class="inner">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="content">
						...
						(성인: <?=number_format($row["people_adult_price"]*$row["people_adult_cnt"]?>원 / 아동: <?=number_format($row["people_kids_price"]*$row["people_kids_cnt"])?>원)
						</span>
                    </td>
        ...
        <!-- <div class="invoice_table invoice_table_new only_web">
            ...
            <table>
                ...
                <tbody>
                <tr>
                    <th class="subject" style="text-align:center">구분</th>
                    <th class="subject" style="text-align:center">영문성</th>
                    <th class="subject" style="text-align:center">영문이름</th>
                </tr>
                <?php
                $i = 0;
                $j = 0;
                    ...
                    <tr>
                        <td class="content">
                            ...
                            if ($rowSub["order_gubun"] == "kids") {
                                $i++;
                                echo "아동 $i";
                            } elseif ($rowSub ["order_gubun"] == "adult") {
                                $j++;
                                echo "성인 $j";
                            }
                            ?>
                        ...
                        <td class="content">
                            <?= $rowSub['order_first_name'] ?>
                        </td>
                        <td class="content">
                            <?= $rowSub['order_last_name'] ?>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
        ...
        <!-- <div class="invoice_table invoice_table_new only_web">
            ...
            <table>
                ...
                <tbody>
                <tr>
                    <th class="subject" style="text-align:center">옵션 이름</th>
                    <th class="subject" style="text-align:center">옵션 가격</th>
                    <th class="subject" style="text-align:center">옵션 수량</th>
                </tr>
                <?php
