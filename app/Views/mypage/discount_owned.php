        ...
        <div class="mypage_wrap">
            ...
            <div class="content">
                ...
                <div class="slide_tab discount flex">
                    <a class="slide_tab_btn" href="../mypage/discount.php">사용 가능한 쿠폰</a>
                    <a class="slide_tab_btn active" href="../mypage/discount_owned.php">지난 쿠폰</a>
                    <a class="slide_tab_btn" href="../mypage/discount_download.php">쿠폰 다운로드</a>
                    <div></div>
                </div>
