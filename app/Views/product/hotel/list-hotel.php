                                    ...
                                    <div class="d_flex align_items_center justify_content_between">
                                        ...
                                        <div class="location_test flex__c">
                                            ...
                                            <div class="location_next">
                                                <span class="text-gray"> <?= $product['code_sub_name'] == "전체" ? "" : $product['code_sub_name'] ?> </span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(".arrow_menu").click(function () {
            ...
            if (tab_box_area.css('display') !== 'none') {
                ...
                tab_box_area.find(".subtitle").css("padding-bottom", "0");
                tab_box_area.css("display", "none");
            } else {
                $(this).css('transform', 'rotate(0)');
                tab_box_area.find(".subtitle").css("padding-bottom", "20px");
