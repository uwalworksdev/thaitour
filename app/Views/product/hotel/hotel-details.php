                                                ...
                                                <div class="room-table-item">
                                                    ...
                                                    <div class="info-price-right">
                                                        <div class="price-details">
                                                            ...
                                                            <div class="price-strike-container">
                                                                <span class="price-strike">202,043바트</span>
                                                                <span class="price">160,430</span>바트
                                                            </div>
                                                            <div class="flex-total">
                                                                <span class="total">총금액: 5,091,454바트</span>
                                ...
                                <a href="/product-hotel/hotel-detail/<?= $item['product_idx'] ?>"
                                   ...
                                   style="width: 393.333px; margin-right: 10px;">
                                    ...
                                    <div class="prd_price_ko">
                                        <?= number_format($item['product_price']) ?> <span> 바트~</span> <span
                                                class="prd_price_thai"><?= number_format($item['product_price_won']) ?> <span>원~</span></span>
                                    </div>
                                </a>
                            <?php endforeach; ?>
                        </div>
                        ...
                        <div class="footer-popup">
                            <div class="des-above">
                                <div class="item">
                                    ...
                                    <span class="text-gray total_price" data-price="">160,430바트</span>
                                </div>
                                <div class="item">
                                    <span class="text-gray">할인금액</span>
                                    <span class="text-gray discount" data-price="">16,040바트</span>
                                </div>
                            </div>
                            <div class="des-below">
