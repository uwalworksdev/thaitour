...
<div class="content-sub-hotel-detail tours-detail spa-detail">
    <div class="body_inner">
        <div class="section1">
            ...
            <?php 
                if(!empty(trim($data_["company_name"])) || !empty(trim($data_["company_contact"])) || !empty(trim($data_["company_url"])) || !isContentEmpty(viewSQ($data_["company_notes"]))){
            ?>
    ...
    function renderData(data) {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            if(check_info_idx != item_.info_idx){
                html += `<tr>
                            <td colspan="3" class="info_op_wrap" style="color: #fff; background-color: #747a90; padding: 5px 15px;">
                                <div class="flex_b_c">
                                    <p class="info_ttl">${item_.info_name}</p>
                                    <p class="info_desc" style="font-size: 14px;">* 부가세/봉사료 포함 가격입니다</p>
                                </div>
                            </td>
                        </tr>`;
            }
