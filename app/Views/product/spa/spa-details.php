    ...
    <div class="content-sub-hotel-detail tours-detail spa-detail">
        <div class="body_inner">
            ...
            <div class="calendar-con">
                <div class="calendar">
                    <div class="header">
                        <img onclick="fn_click_be();" style="cursor: pointer;" src="/uploads/icons/icon_prev_1.png"
                             alt="icon_prev_1" id="prev_icon" class="btn-pre only_web">
                        <img onclick="fn_click_be();" style="cursor: pointer;" src="/uploads/icons/icon_prev_1.png"
                             alt="" id="prev_icon_mo" class="btn-pre only_mo">
                        <p><span id="s_yy"></span>년 <span id="s_mm"></span>월</p>
                        <img onclick="fn_click_ne();" style="cursor: pointer;" src="/uploads/icons/icon_next_1.png"
                             alt="" id="next_icon" class="btn-next only_web">
                        <img onclick="fn_click_ne();" style="cursor: pointer;" src="/uploads/icons/icon_next_1.png"
                             alt="" id="next_icon_mo" class="btn-next only_mo">
                    </div>
                ...
                <div class="price-right-c">
                    <div class="view_nav" id="sticky" style="position: sticky; top: 30px;">
                                ...
                                <ul class="select_peo">
                                    ...
                                    <li class="flex_b_c cus-count-input">
                                        ...
                                        <div class="opt_count_box count_box flex__c">
                                            ...
                                            <input type="text" class="input-qty" name="qty" id="kidsQty" value="0"
                                                   readonly="">
                                    ...
                                    <li class="flex_b_c cus-count-input">
                                        ...
                                        <div class="opt_count_box count_box flex__c">
                                            ...
                                            <input type="text" class="input-qty" name="qty" id="babyQty" value="0"
                                                   readonly="">
                        ...
                        <div class="total_paymemt payment">
                            ...
                            <p class="money"><span style="margin-right:50px;"><strong>합계</strong></span><strong><span
                                            id="total_sum" class="total_sum">0</span></strong> 원 </p>
                        </div>
                        ...
                        <span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0"
                              role="button" aria-label="Go to slide 1" aria-current="true"></span><span
                                ...
                                aria-label="Go to slide 8"></span><span class="swiper-pagination-bullet" tabindex="0"
                                                                        role="button" aria-label="Go to slide 9"></span>
                    </div>
                </div>
                <div class="sub_tour_section7_product_list swiper swiper_product_list_ swiper-initialized swiper-horizontal swiper-backface-hidden">
                    <div class="swiper-wrapper" id="swiper-wrapper-c2d811557361007f3" aria-live="polite">
                        <a href="/product-hotel/hotel-detail/1903"
                           ...
                           aria-label="1 / 9" data-swiper-slide-index="0" style="width: 292.5px; margin-right: 10px;">
                        ...
                        <a href="/product-hotel/hotel-detail/1904"
                           ...
                           aria-label="2 / 9" data-swiper-slide-index="1" style="width: 292.5px; margin-right: 10px;">
                        ...
                        <a href="/product-hotel/hotel-detail/1906" class="sub_tour_section7_product_item swiper-slide"
                           role="group" aria-label="3 / 9" data-swiper-slide-index="2"
                        ...
                        <a href="/product-hotel/hotel-detail/1907" class="sub_tour_section7_product_item swiper-slide"
                           role="group" aria-label="4 / 9" data-swiper-slide-index="3"
                           style="width: 292.5px; margin-right: 10px;">
                        ...
                        <a href="/product-hotel/hotel-detail/1908" class="sub_tour_section7_product_item swiper-slide"
                           role="group" aria-label="5 / 9" data-swiper-slide-index="4"
                           style="width: 292.5px; margin-right: 10px;">
                        ...
                        <a href="/product-hotel/hotel-detail/1909" class="sub_tour_section7_product_item swiper-slide"
                           role="group" aria-label="6 / 9" data-swiper-slide-index="5"
                           style="width: 292.5px; margin-right: 10px;">
                        ...
                        <a href="/product-hotel/hotel-detail/1910" class="sub_tour_section7_product_item swiper-slide"
                           role="group" aria-label="7 / 9" data-swiper-slide-index="6"
                           style="width: 292.5px; margin-right: 10px;">
                        ...
                        <a href="/product-hotel/hotel-detail/1911" class="sub_tour_section7_product_item swiper-slide"
                           role="group" aria-label="8 / 9" data-swiper-slide-index="7"
                           style="width: 292.5px; margin-right: 10px;">
                        ...
                        <a href="/product-hotel/hotel-detail/1912" class="sub_tour_section7_product_item swiper-slide"
                           role="group" aria-label="9 / 9" data-swiper-slide-index="8"
                           style="width: 292.5px; margin-right: 10px;">
