...
<script>
    ...
    function search_it() {
        ...
        const priceMin = $(".content-sub-product-hotel #slider-min").val();
        const priceMax = $(".content-sub-product-hotel #slider-max").val();
        const priceType = $(".content-sub-product-hotel .btn_fil_price.active").data("type");    
