...
<?php $this->section('content'); ?>
                            ...
                            <div class="item">
                                ...
                                <div class="item_right flex__c">
                                    ...
                                    <select data-name="<?=$option['goods_name']?>" 
											...
											data-price_baht="<?=$option['goods_price1'] * $baht_thai?>" class="option_select select_custom_ active_ cus-width" name="option_cnt[]" onchange="calculatePrice();"> 
                                        <option>선택</option>
    ...
    <script>
        ...
        function calculatePrice() {
            ...
            alert(optionPrice1.total_option_price);
            alert(optionPrice1.total_option_price_baht);
