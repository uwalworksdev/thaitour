...
<div class="card-item active_2" data-hole="18" data-hour="06" data-minute="" data-idx="28" data-option_price="500000" data-option_price_baht="11790" data-caddy_fee="그린피에 포함" data-cart_pie_fee="피지에 포함" onclick="selectOption(this)">
        <div class="header">
            ...
            <p class="cus-text">카트피 : 피지에 포함</p>
            <p class="cus-text">그린피 : <span class="font-bold">500,000원(11,790바트)</span></p>
        </div>
    </div><div class="card-item active_2" data-hole="18" data-hour="06" data-minute="" data-idx="28" data-option_price="500000" data-option_price_baht="11790" data-caddy_fee="그린피에 포함" data-cart_pie_fee="피지에 포함" onclick="selectOption(this)">
        <div class="header">
            <div class="header-con">
                <img class="only_web" src="/uploads/icons/timer_gray_icon.png" alt="timer_gray_icon">
                <img class="only_mo" src="/uploads/icons/timer_gray_icon_mo.png" alt="timer_gray_icon_mo">
