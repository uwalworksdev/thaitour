<?php foreach ($options as $option) { ?>
    <div class="card-item" 
        ...
        data-idx               = "<?=$option['idx']?>"
        data-vehicle_price1    = "<?=$option['vehicle_price1']?>"
        data-vehicle_price2    = "<?=$option['vehicle_price2']?>"
        data-vehicle_price3    = "<?=$option['vehicle_price3']?>"
        data-vehicle_o_price1  = "<?=$option['vehicle_o_price1']?>"
        data-vehicle_o_price2  = "<?=$option['vehicle_o_price2']?>"
        data-vehicle_o_price3  = "<?=$option['vehicle_o_price3']?>"
