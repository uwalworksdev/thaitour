...
<section>
    <div class="inner">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="img_box_re">
                            <img src="<?= base_url('/uploads/products/ticket-banner1.png') ?>" alt="">
                            <img src="/uploads/icons/tag-red.png" alt="" class="tag-red">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img_box_re">
                            <img src="<?= base_url('/uploads/products/ticket-banner2.png') ?>" alt="">
                            <img src="/uploads/icons/tag-red.png" alt="" class="tag-red">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img_box_re">
                            <img src="<?= base_url('/uploads/products/ticket-banner3.png') ?>" alt="">
                            <img src="/uploads/icons/tag-g.png" alt="" class="tag-red">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img_box_re">
                    ...
                    <div class="swiper-slide">
                        <div class="img_box_re">
                            <img src="<?= base_url('/uploads/products/ticket-banner3.png') ?>" alt="">
                            <img src="/uploads/icons/tag-p.png" alt="" class="tag-red">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img_box_re">
        ...
        <div class="mid-banner-ticket">
            <img src="<?= base_url('/uploads/products/ticket-mid-banner.png') ?>" alt="">
        </div>
        <div class="ticket-list">
            <div class="ticket-tool">
                ...
                <div class="ticket-tool-r">
                    <input type="text">
                    <img src="/uploads/icons/search-i-ticket.png" alt="" class="ticket-s-i">
                </div>
            </div>
            <div class="tiket-tool-b">
                <div class="btn-gr-ticket">
                    ...
                    <button>전통의상대여(4)</button>
                    <button>공항 라운지(6)</button>
                    <button>액티비티(7)</button>
                    <button>동물원(3)</button>
                    <button>테마파크 (4)</button>
                </div>
                <div class="select-tool">
                    <select name="" id="">
                        <option value="메뉴더보기">메뉴더보기</option>
                    </select>
                </div>
            </div>
