...
<script>
    ...
    function goUrl(key, code) {
        window.location.href = `/show-ticket/1317?keyword=${key}&product_code_2=${code}`;
    }
</script>
<section>
                ...
                <div class="swiper-wrapper">
                    ...
                    <?php foreach ($products as $product) { ?>
                        <div class="swiper-slide"
                             onclick="location.href='/ticket/ticket-detail/<?= $product['product_idx'] ?>'">
            ...
            <div class="">
                <div class="list-ticket-grid " id="list-ticket-grid">
                    ...
                    <?php foreach ($productResults as $product) { ?>
                        <a href="/ticket/ticket-detail/<?= $product['product_idx'] ?>" class="list-ticket-item">
                            <div class="img_box">
