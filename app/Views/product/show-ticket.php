            ...
            <div class="swiper-container-ticket">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        ...
                        <img class="only_web" src="<?= base_url('/uploads/products/ticket-banner1.png') ?>" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="img_box_re">
                        <img class="only_web" src="<?= base_url('/uploads/products/ticket-banner2.png') ?>" alt="">
                        <img class="only_mo img_box_re_img" src="<?= base_url('/uploads/products/spa-banner3_m.png') ?>" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="img_box_re">
                        <img class="only_web" src="<?= base_url('/uploads/products/ticket-banner3.png') ?>" alt="">
                         <img class="only_mo img_box_re_img" src="<?= base_url('/uploads/products/spa-banner3_m.png') ?>" alt="">
