...
<script>
    ...
    function goUrl(key, code) {
        window.location.href = `/product-restaurant/1320?keyword=${key}&product_code_2=${code}`;
    }
</script>
<section>
                ...
                <div class="swiper-wrapper cursor-pointer-con">
                    ...
                    <?php foreach ($products as $product) { ?>
                        <div class="swiper-slide"
                             onclick="location.href='/product-restaurant/restaurant-detail/<?= $product['product_idx'] ?>'">
            ...
            <div class="">
                <div class="list-ticket-grid " id="list-ticket-grid">
                    ...
                    <?php foreach ($productResults as $product) { ?>
                        <a href="/product-restaurant/restaurant-detail/<?= $product['product_idx'] ?>" class="list-ticket-item">
                            <div class="img_box">
                            ...
                            <div class="prd_info prd_info_m ">
                                <div class="prd_info__left">
                                    ...
                                    <span class="star_review_cnt">(<?= $product["total_review"] ?>)</span>
                                </div>
