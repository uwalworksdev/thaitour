                        ...
                        <div class="tbl_rate2 clearfix mb10">
                            <div class="rate_box fl">
                                <ul class="eval1 clearfix pb0">
                                    <li class="avg ltsno"><strong>9.6</strong><b>/10</b></li>
                                    <li>
                                    ...
                                    <li><span>총 <strong><span class=" ltsno">36,730</span></strong>명 참여</span></li>
                                </ul>
                            </div>
                            <div class="totoal_av">
                                <p><span class="rating_avscore">9.7</span></p>
                                <p><span class="rating_avstxt">기사친절</span></p>
                            </div>
                            <div class="totoal_av">
                                <p><span class="rating_avscore">9.6</span></p>
                                <p><span class="rating_avstxt">차량상태</span></p>
                            </div>
                            <div class="totoal_av">
                                <p><span class="rating_avscore">9.7</span></p>
                                <p><span class="rating_avstxt">안전운행</span></p>
                            </div>
                            <div class="totoal_av">
                                <p><span class="rating_avscore">9.7</span></p>
                                <p><span class="rating_avstxt">시간엄수</span></p>
                            </div>
                        </div>

                        <div class="review_list" id="review_list">
                            <div class="tbl_top_wrap">
                                <p class="count">전체 <span>36732개</span>
                                </p>
                            </div>
                                    ...
                                    <div class="supplierinfo">
                                        ...
                                        <div class="drv_ssrvlist">
                                            ...
                                            <div class="ssrv_morelist">
                                                <p class="ssrv_more"><b>1</b>개의 생생한 회원 리뷰가 있어요. ( 평균 고객평점: 10.0) <span
                                                            class="ssrv_more_btn"
